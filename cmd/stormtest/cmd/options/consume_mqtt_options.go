...
func NewConsumeMqttFlags(g *GlobalFlags) *ConsumeMqttFlags {
	return &ConsumeMqttFlags{
		GlobalFlags:     g,
...
func (f *ConsumeMqttFlags) AddFlags(cmd *cobra.Command) {
